...
$baseUrl = "http://192.168.101.234:8080"
...
2. URL: `http://192.168.101.234:8080/message/fetchMessages/ZapFlow`
3. Headers:
   - `apikey: B8349283-F143-429D-B6C2-9386E8016558`
...
```javascript
const ws = new WebSocket('ws://192.168.101.234:8080/chat/ZapFlow');
